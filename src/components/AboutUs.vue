<template>
    <section>
        ...
        <div class="content">
            ...
            <div id="content">
                Hello there! <br> <br>
                My Foodie is a one stop website to cater to all your food needs! <br> 
                <br> 
                With just one click, you can either make reservations, order pickups, and delivery! 
                <br>
                <br> 
                Go check our features and get your food NOW! ;)
            </div>
        </div>
    </section>
</template>
